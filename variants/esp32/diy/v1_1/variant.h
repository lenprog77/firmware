...
#define LORA_RXEN 25 // Input - RF switch RX control, connecting external MCU IO, valid in high level
#define LORA_TXEN 26 // Input - RF switch TX control, connecting external MCU IO or DIO2, valid in high level
